Ext.define('YZModules.${ModuleCode}.Panel.${GridId}', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/${GridId}.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [
                    ...
                    { header: '${item.ItemName}', dataIndex: '${item.ItemId}', width: ${item.DisplayWidth}, align: 'left', sortable: true
                    #if(${item.DisplayFormat}!="Default"&&$!{item.DisplayFormat})
                        ,renderer:XYSoft.Render.render${item.DisplayFormat}
                    #end
                    },
                    #end
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.${ModuleCode}.Panel.${GridId}_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('${ModuleCode}/${GridId}', '', 'New', Ext.apply({
            sender: me,
            title: '新增-${GridTitle}',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('${ModuleCode}/${GridId}', rec.data.${GridKeyId}, 'Edit', Ext.apply({
            sender: me,
            title: '${GridTitle}',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('${ModuleCode}/${GridId}', rec.data.${GridKeyId}, 'Read', Ext.apply({
            sender: me,
            title: '${GridTitle}'
        }, me.dlgCfg));
    },
