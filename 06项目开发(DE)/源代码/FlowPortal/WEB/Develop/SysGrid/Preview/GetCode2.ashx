<%@ WebHandler Language="C#" Class="GetCode2" %>
...
public class GetCode2 : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        Template vltTemplate = vltEngine.GetTemplate("Code.ashx"); //获取模板所在的路径和文件名(相对于指定模板文件夹的位置)
