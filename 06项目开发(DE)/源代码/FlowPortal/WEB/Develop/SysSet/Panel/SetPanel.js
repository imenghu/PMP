Ext.define('Develop.SysSet.Panel.SetPanel', {
    extend: 'Ext.panel.Panel',
    requires: [
        'YZSoft.bpm.src.ux.FormManager',
        'Develop.SysSet.Grid.SetGrid'
    ],
    constructor: function (config) {
        ...
        me.grid = Ext.create('Develop.SysSet.Grid.SetGrid', {
            region: 'center',
            //viewConfig: {
            //    markDirty: false,
            //    plugins: [me.dd]
        ...
        var cfg = {
            ...
            tbar: {
                xtype: 'toolbar',
                cls: 'yz-toolbar-flat',
                items: [me.btnNew,me.btnEdit,me.btnRefreshSet, me.btnExcelExportSet, '->', {
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Dev/SysSet', '', 'New', Ext.apply({
            sender: me,
            title: '新增-数据字典',
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Dev/SysSet', rec.data.SetId, 'Edit', Ext.apply({
            sender: me,
            title: '修改-数据字典',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Dev/SysSet', rec.data.SetId, 'Read', Ext.apply({
            sender: me,
    ...
    deleteSelection: function () {
        ...
        Ext.Msg.show({
            ...
            fn: function (btn, text) {
                ...
                YZSoft.Ajax.request({
                    url: YZSoft.$url(me, '../Service/SysSet.ashx'),
                    method: 'POST',
                    params: {
                        method: 'Delete'
                    },
