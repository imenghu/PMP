Ext.define('Develop.SysSet.Grid.ItemGrid', {
    ...
    constructor: function (config) {
        ...
        var cfg = {
            ...
            columns: [
                ...
                //{ text: '代码标识', dataIndex: 'CodeSetId', width: 80, align: 'left', sortable: sortable },
                {
                    text: '备注', dataIndex: 'Description', width: 100, align: 'left', sortable: sortable, flex: 1
                },
