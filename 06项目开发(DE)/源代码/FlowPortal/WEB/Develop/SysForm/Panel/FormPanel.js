Ext.define('Develop.SysForm.Panel.FormPanel', {
    extend: 'Ext.panel.Panel',
    requires: [
        'YZSoft.bpm.src.ux.FormManager',
        'Develop.SysForm.Grid.FormGrid'
    ],
        ...
        me.dd = Ext.create('Ext.grid.plugin.DragDrop', {
            dragZone: {
                getDragText: function () {
                    ...
                    return record.data.FormName;
                }
            }
        });

        me.grid = Ext.create('Develop.SysForm.Grid.FormGrid', {
            region: 'center',
            //viewConfig: {
            //    markDirty: false,
            //    plugins: [me.dd]
    ...
    onPreview: function () {
        ...
        Ext.create('Develop.SysForm.Preview.PreviewDlg', {
            autoShow: true,
            title: '预览',
            FormName: recs[0].data.FormName
        });
    },
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Dev/SysForm', '', 'New', Ext.apply({
            sender: me,
            title: '新增表单',
    ...
    editSelection: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Dev/SysForm', rec.data.FormName, 'Edit', Ext.apply({
            sender: me,
            title: '修改表单',
            dlgModel: 'Tab', //Tab,Window,Dialog
            listeners: {
    ...
    deleteSelection: function () {
        ...
        Ext.Msg.show({
            ...
            fn: function (btn, text) {
                ...
                YZSoft.Ajax.request({
                    url: YZSoft.$url(me, '../Service/SysForm.ashx'),
                    method: 'POST',
                    params: {
                        method: 'Delete'
                    },
