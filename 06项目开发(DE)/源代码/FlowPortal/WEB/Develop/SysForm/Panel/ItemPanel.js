Ext.define('Develop.SysForm.Panel.ItemPanel', {
    extend: 'Ext.panel.Panel',
    requires: [
        'Develop.SysForm.Grid.ItemGrid'
    ],
    constructor: function (config) {
        ...
        me.grid = Ext.create('Develop.SysForm.Grid.ItemGrid', {
            region: 'center',
    ...
    onBeforeItemDrop: function (node, data, overModel, dropPosition, dropHandlers, eOpts) {
        ...
        YZSoft.Ajax.request({
            ...
            params: {
                ...
                formSetId:me.grid.getStore().getProxy().getExtraParams().FormSetId
            },
            jsonData: names,
            waitMsg: {
                msg: RS.$('All_Moving'),
