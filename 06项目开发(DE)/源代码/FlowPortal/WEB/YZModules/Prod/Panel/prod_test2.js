Ext.define('YZModules.Prod.Panel.prod_test2', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Prod_test2.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: 'CO2', dataIndex: 'co2', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '溶解氧ppb', dataIndex: 'dis_oxygen', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.Prod_test2_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test2', '', 'New', Ext.apply({
            sender: me,
            title: '新增-清酒质检',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test2', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '清酒质检',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test2', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '清酒质检'
        }, me.dlgCfg));
    },
