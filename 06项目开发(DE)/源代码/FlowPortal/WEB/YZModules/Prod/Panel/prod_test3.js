Ext.define('YZModules.Prod.Panel.prod_test3', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Prod_test3.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '品名名称', dataIndex: 'mat_name', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '糖化号', dataIndex: 'sac_id', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '原麦汁浓度°p', dataIndex: 'wort_concent', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '糊精（g/100ml）', dataIndex: 'dextrin', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: 'а－氨基氮（g/100ml）', dataIndex: 'a_nitrogen', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '总酸（ml/100ml）', dataIndex: 'total_acid', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '麦汁滤速', dataIndex: 'wort_filt', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '麦汁透明', dataIndex: 'wort_transp', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '色度（EBC）', dataIndex: 'chroma_ebc', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '浊度EBC', dataIndex: 'turbidity_ebc', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: 'PH值', dataIndex: 'ph', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '苦味质', dataIndex: 'bitter_bu', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.Prod_test3_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test3', '', 'New', Ext.apply({
            sender: me,
            title: '新增-糖化分析',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test3', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '糖化分析',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test3', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '糖化分析'
        }, me.dlgCfg));
    },
