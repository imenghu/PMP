Ext.define('YZModules.Prod.Panel.prod_test11', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Prod_test11.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '气味', dataIndex: 'smell', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '纯度', dataIndex: 'purity', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.Prod_test11_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test11', '', 'New', Ext.apply({
            sender: me,
            title: '新增-二氧化碳检验 ',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test11', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '二氧化碳检验 ',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test11', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '二氧化碳检验 '
        }, me.dlgCfg));
    },
