Ext.define('YZModules.Prod.Panel.prod_test6', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/prod_test6.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '发酵期（天）', dataIndex: 'ferment_days', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '双乙酰（mg/L）', dataIndex: 'diacetyl', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.prod_test6_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test6', '', 'New', Ext.apply({
            sender: me,
            title: '新增-双乙酰数据',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test6', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '双乙酰数据',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test6', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '双乙酰数据'
        }, me.dlgCfg));
    },
