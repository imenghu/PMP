Ext.define('YZModules.Prod.Panel.prod_test8', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/prod_test8.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
                ...
                items: [
                    ...
                    , {
                        header: '公司名称', dataIndex: 'CompanyName', width: 100, align: 'left', sortable: true
                                        ...
                                        { header: '夹杂物 %', dataIndex: 'impurity', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '水份 %', dataIndex: 'moisture', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '无水浸出率 %', dataIndex: 'leach_rate', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '糖化时间/分', dataIndex: 'sac_time', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '糖化酵素力 WK', dataIndex: 'sac_WK', width: 100, align: 'left', sortable: true
                                        },
                                        { header: 'α－氨基氮 mg/L', dataIndex: 'a_nitrogen', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '总酸', dataIndex: 'total_acid', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '发芽率%', dataIndex: 'sprout', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '粉状粒%', dataIndex: 'powdery', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '色度 EBC', dataIndex: 'chroma_ebc', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '煮沸色度 EBC', dataIndex: 'chroma_ebc_boil', width: 100, align: 'left', sortable: true
                                        },
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.prod_test8_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test8', '', 'New', Ext.apply({
            sender: me,
            title: '新增-麦芽质检',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test8', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '麦芽质检',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test8', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '麦芽质检'
        }, me.dlgCfg));
    },
