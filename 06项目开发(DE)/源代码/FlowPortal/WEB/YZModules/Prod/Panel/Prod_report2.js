Ext.define('YZModules.Prod.Panel.prod_report2', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Prod_report2.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.Prod_report2_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_report2', '', 'New', Ext.apply({
            sender: me,
            title: '新增-过滤酒损',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_report2', rec.data.report_id, 'Edit', Ext.apply({
            sender: me,
            title: '过滤酒损',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_report2', rec.data.report_id, 'Read', Ext.apply({
            sender: me,
            title: '过滤酒损'
        }, me.dlgCfg));
    },
