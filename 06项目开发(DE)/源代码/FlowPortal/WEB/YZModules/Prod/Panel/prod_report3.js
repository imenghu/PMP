Ext.define('YZModules.Prod.Panel.prod_report3', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/prod_report3.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        { header: '车间', dataIndex: 'workshop', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '产线', dataIndex: 'product_line', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '产量', dataIndex: 'yield', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '品名', dataIndex: 'Prod_name', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '规格', dataIndex: 'spec', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '日期', dataIndex: 'input_date', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '本日接清酒量', dataIndex: 'today_saka_amount', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '本日成品量', dataIndex: 'today_product_num', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '本日酒损', dataIndex: 'today_loss', width: 100, align: 'left', sortable: true
                                        },
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules..Panel.prod_report3_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_report3', '', 'New', Ext.apply({
            sender: me,
            title: '新增-包装车间',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_report3', rec.data.report_id, 'Edit', Ext.apply({
            sender: me,
            title: '包装车间',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_report3', rec.data.report_id, 'Read', Ext.apply({
            sender: me,
            title: '包装车间'
        }, me.dlgCfg));
    },
