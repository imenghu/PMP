Ext.define('YZModules.Prod.Panel.prod_test1', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/prod_test1.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test1', '', 'New', Ext.apply({
            sender: me,
            title: '新增-啤酒后发酵质检',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test1', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '啤酒后发酵质检',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test1', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '啤酒后发酵质检'
        }, me.dlgCfg));
    },
