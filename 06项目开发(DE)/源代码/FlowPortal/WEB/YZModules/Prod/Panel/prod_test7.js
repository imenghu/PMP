Ext.define('YZModules.Prod.Panel.prod_test7', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Prod_test7.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
                    ...
                    { xtype: 'rownumberer' },
                      {
                          header: '公司名称', dataIndex: 'CompanyName', width: 100, align: 'left', sortable: true
                                        ...
                                        {
                                            header: '生产线', dataIndex: 'production_line', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                        ...
                                        {
                                            header: '最高杀菌温度oC', dataIndex: 'steril_temp_max', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: 'PU（50oC）', dataIndex: 'pu50', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '致死PU（60oC）', dataIndex: 'pu60', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.Prod_test7_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test7', '', 'New', Ext.apply({
            sender: me,
            title: '新增-PU质检',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test7', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: 'PU质检',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test7', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: 'PU质检'
        }, me.dlgCfg));
    },
