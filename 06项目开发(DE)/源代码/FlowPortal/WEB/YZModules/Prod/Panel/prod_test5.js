Ext.define('YZModules.Prod.Panel.prod_test5', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/prod_test5.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '清酒罐溶解氧ppb', dataIndex: 'dis_oxygen1', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '酒机前溶解氧ppb', dataIndex: 'dis_oxygen2', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '生酒溶解氧ppb', dataIndex: 'dis_oxygen3', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '备注（离心或稀释）', dataIndex: 'memo', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.prod_test5_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test5', '', 'New', Ext.apply({
            sender: me,
            title: '新增-溶解氧质检',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test5', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '溶解氧质检',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_test5', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '溶解氧质检'
        }, me.dlgCfg));
    },
