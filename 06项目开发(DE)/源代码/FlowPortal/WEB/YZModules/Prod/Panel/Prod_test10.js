Ext.define('YZModules.Prod.Panel.prod_test10', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Prod_test10.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '固形物含量（≥75）', dataIndex: 'solid', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '透光率%（≥96）', dataIndex: 'transmit', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: 'PH（4.6-6.0）', dataIndex: 'ph', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.Prod_test10_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test10', '', 'New', Ext.apply({
            sender: me,
            title: '新增-糖浆质检',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test10', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '糖浆质检',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test10', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '糖浆质检'
        }, me.dlgCfg));
    },
