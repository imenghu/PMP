Ext.define('YZModules.Prod.Panel.prod_report4', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/prod_report4.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '日期', dataIndex: 'date', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '品名', dataIndex: 'mat_name', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '糖化批次', dataIndex: 'Sac_id', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '锅次', dataIndex: 'Boiler', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '大麦芽', dataIndex: 'malt_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '焦香麦芽', dataIndex: 'caramelmalt_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '小麦芽', dataIndex: 'smallmalt_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '糖浆kg', dataIndex: 'syrup_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '总kg', dataIndex: 'sum_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '澳麦芽', dataIndex: 'Australian_malt', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '冷麦汁KL', dataIndex: 'coldwort_kl', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '原麦汁浓度OP', dataIndex: 'wort_concent', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '折11冷k', dataIndex: 'convert11_kl', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '折11粮耗kg/kl', dataIndex: 'convert11_loss_kl', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '单宁kg', dataIndex: 'Tannin_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '卡拉胶kg', dataIndex: 'carrageenan_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '进口香花卡斯卡特kg', dataIndex: 'imported_fragrant_kg', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.prod_report4_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_report4', '', 'New', Ext.apply({
            sender: me,
            title: '新增-糖化日报',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_report4', rec.data.report_id, 'Edit', Ext.apply({
            sender: me,
            title: '糖化日报',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/prod_report4', rec.data.report_id, 'Read', Ext.apply({
            sender: me,
            title: '糖化日报'
        }, me.dlgCfg));
    },
