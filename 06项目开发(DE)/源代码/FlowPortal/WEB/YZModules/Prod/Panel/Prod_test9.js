Ext.define('YZModules.Prod.Panel.prod_test9', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Prod_test9.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '类型', dataIndex: 'hops_type', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '外观', dataIndex: 'appearance', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '香气', dataIndex: 'aroma', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '水分', dataIndex: 'moisture', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: 'a-酸', dataIndex: 'a_acid', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: 'B-酸', dataIndex: 'b_acid', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '贮藏指数', dataIndex: 'storable', width: 100, align: 'left', sortable: true
                                        },
                                        {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Prod.Panel.Prod_test9_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test9', '', 'New', Ext.apply({
            sender: me,
            title: '新增-啤酒花检验',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test9', rec.data.test_id, 'Edit', Ext.apply({
            sender: me,
            title: '啤酒花检验',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Prod/Prod_test9', rec.data.test_id, 'Read', Ext.apply({
            sender: me,
            title: '啤酒花检验'
        }, me.dlgCfg));
    },
