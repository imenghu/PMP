Ext.define('YZModules.Sal.Panel.sal_invoice', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/sal_invoice.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                    {
                        header: '公司', dataIndex: 'CompanyName', width: 100, align: 'left', sortable: true
                                        ...
                                        {
                                            header: '发票号', dataIndex: 'invoice_code', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '类型', dataIndex: 'invoice_type', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '金额', dataIndex: 'invoice_money', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '财务名称', dataIndex: 'finance_name', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '票面日期', dataIndex: 'invoice_date', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '录入日期', dataIndex: 'insert_date', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '操作', dataIndex: 'invoice_id', width: 100, align: 'center', sortable: true, renderer: me.renderRead, listeners: { scope: me, click: me.onClickNo } },
                ]
            },
            ...
            tbar: {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        //    var pnl = Ext.create({
                        //        xclass: 'YZModules.Sal.Panel.sal_invoice_SearchPanel',
                        //        region: 'north',
                        //        store: me.store
                        //    });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sal/sal_invoice', '', 'New', Ext.apply({
            sender: me,
            title: '新增-发票明细',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sal/sal_invoice', rec.data.invoice_id, 'Edit', Ext.apply({
            sender: me,
            title: '发票明细',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sal/sal_invoice', rec.data.invoice_id, 'Read', Ext.apply({
            sender: me,
            title: '发票明细'
        }, me.dlgCfg));
    },
