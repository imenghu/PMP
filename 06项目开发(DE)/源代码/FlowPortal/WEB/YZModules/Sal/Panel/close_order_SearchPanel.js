...
Ext.define('YZModules.Sal.Panel.close_order_SearchPanel', {
    ...
    constructor: function (config) {
        ...
        me.salesman_name = Ext.create('Ext.form.field.Text', {
            fieldLabel: '销售员姓名',
            allowBlank: true
        });
    ...
    onSearchClick: function () {
        ...
        Ext.apply(params, {
            ...
            salesman_name: me.salesman_name.getValue(),
