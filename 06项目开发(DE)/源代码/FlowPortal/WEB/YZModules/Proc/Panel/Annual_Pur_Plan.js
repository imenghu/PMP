Ext.define('YZModules.Proc.Panel.Annual_Pur_Plan', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            sorters: {
                property: 'plan_pur_id',
                direction: 'DESC'
            },
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/Annual_Pur_Plan.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [
                    ...
                    { header: '年份', dataIndex: 'plan_pur_year', width: 60, align: 'left', sortable: true },
                    { header: "提报人", dataIndex: 'CreateUserName', width: 80, align: 'left', sortable: true },
                    { header: '物料编码', dataIndex: 'mat_code', width: 80, align: 'left', sortable: true },
                    { header: '物料名称', dataIndex: 'mat_name', minwidth: 100, align: 'left', sortable: true },
                    { header: '规格', dataIndex: 'mat_spec', width: 80, align: 'left', sortable: true },
                    { header: '总数量', dataIndex: 'plan_total_num', width: 80, align: 'left', sortable: true },
                    { header: '单位', dataIndex: 'plan_stnum_unit', width: 60, align: 'left', sortable: true },
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Proc.Panel.Annual_Pur_Plan_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Proc/annual_pur_plan', '', 'New', Ext.apply({
            sender: me,
            title: '新增-采购计划',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Proc/annual_pur_plan', rec.data.plan_pur_id, 'Edit', Ext.apply({
            sender: me,
            title: Ext.String.format('采购计划'),
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Proc/annual_pur_plan', rec.data.plan_pur_id, 'Read', Ext.apply({
            sender: me,
            title: Ext.String.format('采购计划')
        }, me.dlgCfg));
    },
