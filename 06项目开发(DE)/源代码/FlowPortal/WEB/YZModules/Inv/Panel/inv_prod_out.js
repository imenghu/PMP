Ext.define('YZModules.Inv.Panel.inv_prod_out', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            sorters: {
                property: 'prod_out_id',
                direction: 'DESC'
            },
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/inv_prod_out.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Inv.Panel.inv_prod_out_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Inv/inv_prod_out', '', 'New', Ext.apply({
            sender: me,
            title: '新增-产成品出库',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Inv/inv_prod_out', rec.data.prod_out_id, 'Edit', Ext.apply({
            sender: me,
            title: '产成品出库',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Inv/inv_prod_out', rec.data.prod_out_id, 'Read', Ext.apply({
            sender: me,
            title: '产成品出库'
        }, me.dlgCfg));
    },
