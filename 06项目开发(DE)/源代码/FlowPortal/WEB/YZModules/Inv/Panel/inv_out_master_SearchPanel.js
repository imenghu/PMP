...
Ext.define('YZModules.Inv.Panel.inv_out_master_SearchPanel', {
    ...
    constructor: function (config) {
        ...
        me.Inv_out_user = Ext.create('Ext.form.field.Text', {
            fieldLabel: '领用人姓名',
            allowBlank: true,
    ...
    onSearchClick: function () {
        ...
        Ext.apply(params, {
            ...
            Inv_out_user: me.Inv_out_user.getValue(),
