Ext.define('YZModules.Inv.Panel.inv_matrefund', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/inv_matrefund.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Inv/inv_matrefund', rec.data.mat_refund_id, 'Edit', Ext.apply({
            sender: me,
            title: '物料退库',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Inv/inv_matrefund', rec.data.mat_refund_id, 'Read', Ext.apply({
            sender: me,
            title: '物料退库'
        }, me.dlgCfg));
    },
    ...
    deleteSelection: function () {
        ...
        Ext.each(recs, function (rec) {
            ids.push(rec.data.mat_refund_id);
        });
