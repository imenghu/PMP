Ext.define('YZModules.Inv.Panel.inv_inventory_master', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            sorters: {
                property: 'inv_mast_id',
                direction: 'DESC'
            },
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/inv_inventory_master.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        { header: '盘点人公司', dataIndex: 'CompanyName', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '盘点人部门', dataIndex: 'DeptName', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '盘点人', dataIndex: 'CreateUserName', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '年', dataIndex: 'inv_master_year', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '月', dataIndex: 'inv_master_month', width: 100, align: 'left', sortable: true
                                        },
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Inv/inv_inventory_master', rec.data.inv_mast_id, 'Edit', Ext.apply({
            sender: me,
            title: '物料盘存',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Inv/inv_inventory_master', rec.data.inv_mast_id, 'Read', Ext.apply({
            sender: me,
            title: '物料盘存'
        }, me.dlgCfg));
    },
