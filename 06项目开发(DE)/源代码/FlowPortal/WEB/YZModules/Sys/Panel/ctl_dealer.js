Ext.define('YZModules.Sys.Panel.ctl_dealer', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/ctl_dealer.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
            ...
            columns: {
                ...
                items: [
                    { xtype: 'rownumberer' },
                                        ...
                                        {
                                            header: '邮编', dataIndex: 'dealer_zipcode', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '联系人', dataIndex: 'dealer_contact', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '联系电话', dataIndex: 'dealer_tel', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '联系邮箱', dataIndex: 'dealer_email', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '地址', dataIndex: 'dealer_addr', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '微信', dataIndex: 'dealer_wechat', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: 'QQ', dataIndex: 'dealer_qq', width: 100, align: 'left', sortable: true
                                        },
                                        {
                                            header: '备注', dataIndex: 'dealer_remarks', width: 100, align: 'left', sortable: true
                                        },
                                        { header: '操作', dataIndex: 'dealer_id', width: 100, align: 'center', sortable: true, renderer: me.renderRead, listeners: { scope: me, click: me.onClickNo } },
                ]
            },
                ...
                items: [
                    ...
                    '搜索条件', {
                        ...
                        createSearchPanel: function () {
                            var pnl = Ext.create({
                                xclass: 'YZModules.Sys.Panel.ctl_dealer_SearchPanel',
                                region: 'north',
                                store: me.store
                            });
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sys/ctl_dealer', '', 'New', Ext.apply({
            sender: me,
            title: '新增-经销商信息',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sys/ctl_dealer', rec.data.dealer_id, 'Edit', Ext.apply({
            sender: me,
            title: '经销商信息',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sys/ctl_dealer', rec.data.dealer_id, 'Read', Ext.apply({
            sender: me,
            title: '经销商信息'
        }, me.dlgCfg));
    },
