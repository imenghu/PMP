Ext.define('YZModules.Sys.Panel.ctl_depot', {
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                type: 'ajax',
                url: YZSoft.$url(me, '../Service/ctl_depot.ashx'),
                extraParams: {
                    method: 'GetData'
                },
                reader: {
    ...
    addNew: function () {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sys/ctl_depot', '', 'New', Ext.apply({
            sender: me,
            title: '新增-仓库管理',
            dlgModel: 'Tab', //Tab,Window,Dialog
            width: 600,
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sys/ctl_depot', rec.data.depot_id, 'Edit', Ext.apply({
            sender: me,
            title: '仓库管理',
            listeners: {
    ...
    read: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Sys/ctl_depot', rec.data.depot_id, 'Read', Ext.apply({
            sender: me,
            title: '仓库管理'
        }, me.dlgCfg));
    },
