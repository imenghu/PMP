                    ...
                    <td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="158" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        <aspxform:XTextBox id="XTextBox2" runat="server" FieldName="合同编号" BorderColor="#DCDCDC" width="100%" XDataBind="SFDATA:proc_contract.contract_code"></aspxform:XTextBox>
                                    </td>
                                    <td width="158" class="xfld" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        合同类型</td>
                                    <td width="158" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        <aspxform:XDropDownList id="XDropDownList1" runat="server" FieldName="合同类型" XDataBind="SFDATA:proc_contract.contract_type" PromptText="--请选择--">
                                    ...
                                    <td width="158" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none" colspan="1">
                                        <aspxform:XTextBox id="XTextBox6" runat="server" FieldName="合同名称" BorderColor="#DCDCDC" width="100%" XDataBind="SFDATA:proc_contract.contract_name"></aspxform:XTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        <aspxform:XTextBox id="XTextBox3" runat="server" FieldName="供应商名称" BorderColor="#DCDCDC" width="80%" XDataBind="SFDATA:proc_contract.vendor_name" DisableExpress="1"></aspxform:XTextBox>
                                    ...
                                    <td class="xfld" style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        委外</td>
                                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        <aspxform:XDropDownList id="XDropDownList2" runat="server" FieldName="委外" XDataBind="SFDATA:proc_contract.if_outsource" PromptText="--请选择--">
                                    ...
                                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none" colspan="1">
                                        <aspxform:XTextBox id="XTextBox7" runat="server" FieldName="总金额" BorderColor="#DCDCDC" width="100%" XDataBind="SFDATA:proc_contract.total_price"></aspxform:XTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="34" class="xfld" style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        提交人</td>
                                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        <aspxform:XTextBox id="XTextBox4" runat="server" FieldName="提交人" BorderColor="#DCDCDC" width="100%" XDataBind="SFDATA:proc_contract.CreateUserName" DisableExpress="1"></aspxform:XTextBox>
                                    </td>
                                    <td class="xfld" style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        签订人员</td>
                                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                        <aspxform:XTextBox id="XTextBox5" runat="server" FieldName="签订人员" BorderColor="#DCDCDC" width="80%" XDataBind="SFDATA:proc_contract.SignUserName" DisableExpress="1"></aspxform:XTextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none" colspan="5">
                                        <aspxform:XAttachments id="XAttachments1" runat="server" FieldName="附件" width="100%" XDataBind="SFDATA:proc_contract.attachment" FileTypesDescription="Word,Excel,Pdf" FileTypes="*.doc;*.docx;*.xls;*.xlsx;*.pdf;*.png;*.jpg;*.jpeg;*.gif"></aspxform:XAttachments>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox1" runat="server" FieldName="物料编码" BorderColor="#DCDCDC" width="120px" XDataBind="varcode" DisableExpress="1" ValueToDisplayText></aspxform:XTextBox>
                                            ...
                                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator6" runat="server" Display="None" ForeColor="Red" ErrorMessage="请选择物料编码" ControlToValidate="XTextBox1">物料编码</aspxform:XRequiredFieldValidator>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox10" runat="server" FieldName="物料名称" BorderColor="#DCDCDC" width="100%" XDataBind="varname" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox11" runat="server" FieldName="物料规格" BorderColor="#DCDCDC" width="100%" XDataBind="varspec" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox12" runat="server" FieldName="申购数量" BorderColor="#DCDCDC" width="100%" XDataBind="varslnum" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox13" runat="server" FieldName="申购单位" BorderColor="#DCDCDC" width="100%" XDataBind="varunit" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox14" runat="server" FieldName="计划单价" BorderColor="#DCDCDC" width="100%" XDataBind="varprice" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox15" runat="server" FieldName="价格单位" BorderColor="#DCDCDC" width="100%" XDataBind="varpriceunit" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox16" runat="server" FieldName="计划金额" BorderColor="#DCDCDC" width="100%" XDataBind="varsprice" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XDateTimePicker id="XDateTimePicker1" runat="server" FieldName="计划到货时间" BorderColor="#DCDCDC" XDataBind="vartime" Width="100%" DisplayOnly="True"></aspxform:XDateTimePicker>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XDropDownList id="XDropDownList3" runat="server" FieldName="是否紧急" XDataBind="varurg" DisableExpress="1" Width="100%">
                                                <asp:ListItem Selected="True" Value="0">否</asp:ListItem>
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                            </aspxform:XDropDownList>
                                        </td>
                                        <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                                            <aspxform:XTextBox id="XTextBox19" runat="server" FieldName="备注" BorderColor="#DCDCDC" XDataBind="varremark" DisableExpress="1"></aspxform:XTextBox>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <table width="462" align="center" border="0" cellspacing="0" cellpadding="0" hiddenexpress="1">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator1" runat="server" Display="None" ForeColor="Red" ErrorMessage="请填写合同编号" ControlToValidate="XTextBox2">合同编号</aspxform:XRequiredFieldValidator>
                                    </td>
                                    <td>
                                        <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator2" runat="server" Display="None" ForeColor="Red" ErrorMessage="请选择合同类型" ControlToValidate="XDropDownList1">合同类型</aspxform:XRequiredFieldValidator>
                                    </td>
                                    <td>
                                        <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator3" runat="server" Display="None" ForeColor="Red" ErrorMessage="请选择供应商名称" ControlToValidate="XTextBox3">供应商名称</aspxform:XRequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator4" runat="server" Display="None" ForeColor="Red" ErrorMessage="请选择是否委外" ControlToValidate="XDropDownList2">委外</aspxform:XRequiredFieldValidator>
                                    </td>
                                    <td>
                                        <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator5" runat="server" Display="None" ForeColor="Red" ErrorMessage="请选择签订人员" ControlToValidate="XTextBox5">签订人员</aspxform:XRequiredFieldValidator>
                                    </td>
                                    <td>
                                    </td>
                                </tr>
