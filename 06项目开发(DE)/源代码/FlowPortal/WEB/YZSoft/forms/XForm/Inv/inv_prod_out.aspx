            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XDropDownList id="XDropDownList2" runat="server" XDataBind="SFDATA:inv_prod_out.depot_id" DataMap="depot_name->SFDATA:inv_prod_out.depot_name" XDataSource="DataSource:SFDATA;TableName:ctl_depot" PromptText="--请选择--" DisplayColumn="depot_name" ValueColumn="depot_id"></aspxform:XDropDownList>
                    </td>
                    <td width="100" height="25" class="xfld" style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        基准单位 
                    </td>
