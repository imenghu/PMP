        ...
        <table width="960" align="center" style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XTextBox id="ctrlProd_test2mat_name" runat="server" width="100%" XDataBind="SFDATA:Prod_test2.mat_name"></aspxform:XTextBox>
                    </td>
                    <td width="100" height="25" class="xfld" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        罐号 
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <aspxform:XTextBox id="ctrlProd_test2memo" runat="server" width="100%" XDataBind="SFDATA:Prod_test2.memo"></aspxform:XTextBox>
                    </td>
                    <td>
                    </td>
                    <td>
