            ...
            <tbody>
                <tr>
                    ...
                    <td width="214" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XDataBrowserButton id="XDataBrowserButton1" runat="server" DataMap="mat_name->SFDATA:prod_report1.mat_name" Width="21px" XDataSource='DataSource:SFDATA;TableName:ctl_material;Filter:first_name->"产成品"' DisplayColumns="first_name:;second_name:;third_name:;fourth_name:;mat_name:;mat_spec:"></aspxform:XDataBrowserButton>
                        <aspxform:XTextBox id="ctrlProd_report1mat_name" runat="server" width="80%" XDataBind="SFDATA:Prod_report1.mat_name" FieldName="品名"></aspxform:XTextBox>
                    </td>
                    ...
                    <td width="214" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XDateTimePicker id="ctrlProd_report1full_tank_date" runat="server" width="100%" XDataBind="SFDATA:Prod_report1.full_tank_date" FieldName="满罐日期"></aspxform:XDateTimePicker>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XDateTimePicker id="ctrlProd_report1export_date" runat="server" width="100%" XDataBind="SFDATA:Prod_report1.export_date" FieldName="导出日期"></aspxform:XDateTimePicker>
                    </td>
                ...
                <tr>
                    ...
                    <td style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XDateTimePicker id="ctrlProd_report1end_date" runat="server" width="100%" XDataBind="SFDATA:Prod_report1.end_date" FieldName="结束日期"></aspxform:XDateTimePicker>
                    </td>
                </tr>
                <tr>
                    <td height="34" class="xfld" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
