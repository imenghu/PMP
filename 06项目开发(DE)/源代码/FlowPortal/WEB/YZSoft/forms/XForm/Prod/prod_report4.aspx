...
$Scripts-->
        ...
        <table width="960" align="center" style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td width="100" height="32" class="xfld" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        品名 
                    </td>
                    <td style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XDataBrowserButton id="XDataBrowserButton1" runat="server" DataMap="mat_name->SFDATA:prod_report4.mat_name" DisplayColumns="first_name:;second_name:;third_name:;fourth_name:;mat_name:;mat_spec:" XDataSource='DataSource:SFDATA;TableName:ctl_material;Filter:first_name->"产成品"' Width="21px"></aspxform:XDataBrowserButton>
                        <aspxform:XTextBox id="ctrlprod_report4mat_name" runat="server" width="80%" XDataBind="SFDATA:prod_report4.mat_name" FieldName="品名"></aspxform:XTextBox>
                    </td>
