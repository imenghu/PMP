...
Ext.define('2020.src.SFBIPortal', {
    ...
    launch: function () {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                me.btnHome = Ext.create('Ext.button.Button', {
                ...
                me.btnApp = Ext.create('Ext.button.Button', {
                    cls: 'yz-btn-portal-title yz-size-icon-18 yz-btn-messageindicator-task',
                    glyph: 0xe608,
                    margin: '0 20 0 0',
                    handler: function () {
                        window.location.href='../Default.aspx?StartApp=2020/SF';
                    }
                });
