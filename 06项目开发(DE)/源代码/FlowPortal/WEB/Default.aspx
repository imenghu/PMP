...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        YZManifest.css = [{
            ...
            path: 'Develop/SysForm/Preview/CodeMirror/codemirror.css'
        }];
        ...
        YZManifest.js = [{
            ...
            path: 'Develop/Utility/XYSoft.js'
        }, {
            path: 'Develop/SysForm/Preview/CodeMirror/codemirror.js'
        }, {
            path: 'Develop/SysForm/Preview/CodeMirror/htmlmixed.js'
        }, {
